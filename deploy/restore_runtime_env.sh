...
emit_runtime_env() {
  ...
  printf 'STRUCTURED_RECOMMENDATION_MODEL="openai.gpt-oss-120b"\n'
  printf 'MENU_PRESENTATION_MODEL="xai.grok-4.3"\n'
  printf 'OPTION_LOCALIZATION_MODEL="openai.gpt-oss-20b"\n'
  printf 'OPTION_LOCALIZATION_MODEL_CHAIN="openai.gpt-oss-20b,openai.gpt-oss-120b"\n'
  printf 'RECOMMENDATION_SELECTION_MAX_OUTPUT_TOKENS="2048"\n'
  printf 'MENU_PRESENTATION_MAX_OUTPUT_TOKENS="4096"\n'
  printf 'OPTION_LOCALIZATION_MAX_OUTPUT_TOKENS="16384"\n'
  printf 'STRUCTURED_RECOMMENDATION_MAX_OUTPUT_TOKENS="16384"\n'
  ...
  printf 'OCI_GENAI_MAX_OUTPUT_TOKENS="16384"\n'
...
required=(
  ...
  OPTION_LOCALIZATION_MODEL OPTION_LOCALIZATION_MODEL_CHAIN
  MENU_PRESENTATION_MODEL MENU_PRESENTATION_MAX_OUTPUT_TOKENS
  STRUCTURED_RECOMMENDATION_MODEL RECOMMENDATION_SELECTION_MAX_OUTPUT_TOKENS
