...
RUNTIME_OCI_OUTPUT_POLICY = 'OCI_GENAI_MAX_OUTPUT_TOKENS="16384"'
...
RUNTIME_ADMISSION_ENABLED_POLICY = 'OCI_GENAI_ADMISSION_CONTROL_ENABLED="true"'
...
RUNTIME_RATE_LIMIT_COOLDOWN_POLICY = 'OCI_GENAI_RATE_LIMIT_COOLDOWN_SECONDS="30"'
...
RUNTIME_SELECTION_OUTPUT_POLICY = 'RECOMMENDATION_SELECTION_MAX_OUTPUT_TOKENS="2048"'
RUNTIME_MENU_PRESENTATION_OUTPUT_POLICY = 'MENU_PRESENTATION_MAX_OUTPUT_TOKENS="4096"'
...
RUNTIME_RECOMMENDATION_PASSAGES_POLICY = 'RECOMMENDATION_LLM_PASSAGES_PER_MENU="2"'
...
def write_env(
    ...
    lines = [
        ...
        f"OCI_GENAI_ADMISSION_CONTROL_ENABLED={quote('true')}",
        f"OCI_GENAI_MAX_CONCURRENT_REQUESTS_PER_MODEL={quote('1')}",
        f"OCI_GENAI_MIN_INTERVAL_SECONDS={quote('2')}",
        f"OCI_GENAI_RATE_LIMIT_COOLDOWN_SECONDS={quote('30')}",
        ...
        f"RECOMMENDATION_SELECTION_MAX_OUTPUT_TOKENS={quote('2048')}",
        f"MENU_PRESENTATION_MAX_OUTPUT_TOKENS={quote('4096')}",
...
def persist_runtime_release_policy(path: Path = RUNTIME_ENV) -> bool:
    ...
    for key, policy in (
        ...
        ("OCI_GENAI_ADMISSION_CONTROL_ENABLED", RUNTIME_ADMISSION_ENABLED_POLICY),
        (
            "OCI_GENAI_MAX_CONCURRENT_REQUESTS_PER_MODEL",
            RUNTIME_MODEL_CONCURRENCY_POLICY,
        ),
        ("OCI_GENAI_MIN_INTERVAL_SECONDS", RUNTIME_MODEL_INTERVAL_POLICY),
        (
            "OCI_GENAI_RATE_LIMIT_COOLDOWN_SECONDS",
            RUNTIME_RATE_LIMIT_COOLDOWN_POLICY,
        ),
        ("RESTAURANT_NOTE_MODEL", RUNTIME_NOTE_MODEL_POLICY),
        ("RESTAURANT_NOTE_MODEL_CHAIN", RUNTIME_NOTE_MODEL_CHAIN_POLICY),
        ...
        (
            ...
            RUNTIME_SELECTION_OUTPUT_POLICY,
        ),
        (
        ...
        (
            ...
            RUNTIME_OPTION_LOCALIZATION_OUTPUT_POLICY,
        ),
        (
        ...
        (
            ...
            RUNTIME_RECOMMENDATION_PASSAGES_POLICY,
        ),
        (
        ...
        os.environ.update(
            {
                ...
                "RECOMMENDATION_SELECTION_MAX_OUTPUT_TOKENS": "2048",
                "MENU_PRESENTATION_MAX_OUTPUT_TOKENS": "4096",
