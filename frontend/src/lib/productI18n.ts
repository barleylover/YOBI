...
const entryEn: EntryCopy = {
  ...
  countryHelp: (language) => `Country helps YOBI localize comparisons; it does not change dish ranking. Countries commonly using ${language} appear first.`,
  start: "Get started",
  localeApplies: "Language applies to recommendations, ordering and the pre-payment handoff.",
  experienceNotice: "Review your dish and delivery details before continuing.",
};

const entryKo: EntryCopy = {
  heroTitle: "한국 음식,",
  heroBuddy: "이제 어렵지 않아요",
  pitchTitle: "추측 대신 맥락으로 한국 음식을 골라보세요.",
  pitchDescription: "무엇이 먹고 싶은지 YOBI에게 알려주세요. 모든 추천은 식단, 맵기 한도, 예산에 맞춰 확인되고 출처까지 검증할 수 있어요.",
...
const en: ProductCopy = {
  ...
  address: {
    ...
    description: "We only use it to find restaurants near you.",
    ...
    consent: "I allow YOBI to use this address to find delivery options for this session. It won’t be stored after I leave.",
    check: "Find address",
  ...
  recommendation: {
    assistantName: "YOBI",
    ready: "I prepared dishes that fit your saved choices.",
    foodDescription: "About this food",
    deliveryFee: "Delivery fee",
    freeDelivery: "Free",
    previous: "Previous dish",
    next: "Next dish",
    cardPosition: (current, total) => `Dish ${current} of ${total}`,
    compareLoading: "YOBI is comparing these dishes using the current dish and Wiki evidence…",
    ...
    previewCount: (menus, merchants) => `${menus} dishes from ${merchants} restaurants currently fit`,
  ...
  navigation: {
    ...
    close: "Close",
    demoRankingNotice: "Prepared ranking for this delivery area—not live Yogiyo review, order, or popularity data.",
    reviews: "Most reviewed",
    orders: "Most ordered",
    koreanPopularity: "Popular in Korea",
    loading: "Loading available dishes…",
    unavailable: "This collection is unavailable right now. No unavailable dish has been substituted.",
    noFeatureMenus: "None of the dishes from the show are available near you yet.",
    featureTitle: "K-food from K-pop Demon Hunters, available near you",
    featureDescription: "Explore dishes featured in K-pop Demon Hunters and mapped dishes currently available in this prepared delivery area.",
    selectMenu: "Choose this dish",
  },
  handoff: {
    eyebrow: "Ready for the next step",
    title: "Continue in Yogiyo to order",
    description: "Want to order the Korean dish you picked? Continue in Yogiyo.",
...
const ko: ProductCopy = {
  ...
  address: {
    step: "배달 정보",
    title: "어디로 배달하면 될까요?",
    description: "가까운 식당을 찾는 데만 사용해요.",
    search: "주소 검색",
    bookingImage: "예약 이미지",
