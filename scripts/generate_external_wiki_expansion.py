...
DISHES: Sequence[DishSpec] = (
    DishSpec("salad", "샐러드", "Salad", ("샐러드", "mixed salad"), None, "A salad is a composed dish built around vegetables, grains, fruit, noodles or other bite-sized components, commonly served with a dressing. Leafy versions often emphasize fresh, clean flavours, while grain or protein salads can be more filling.", "Salad is commonly served cool or at room temperature. Its texture may be crisp and crunchy, soft, chewy or hearty depending on the base and toppings, so the name alone does not identify dressing, protein or dietary suitability."),
    DishSpec("poke", "포케", "Poke bowl", ("포케", "포케볼", "poke bowl"), None, "A poke bowl is a composed bowl meal commonly pairing a rice or vegetable base with cut toppings and sauce. Contemporary menus include seafood, meat, tofu and vegetable versions, making the rice, protein and dressing product-specific.", "It is usually served cool or at room temperature, combining soft or chewy grains with crisp or crunchy toppings. The word poke does not guarantee raw fish, a specific sauce, a particular protein or a clean-and-mild flavour."),
    DishSpec("pasta", "파스타", "Pasta", ("파스타", "pasta dish"), "italian", "Pasta is an Italian noodle family shaped into strands, tubes, sheets and filled forms, then paired with sauces, broths or baked preparations. The noodles may be boiled before finishing in sauce or assembled into a baked dish.", "Pasta is generally served warm or hot with a soft or chewy bite. It may taste light and tangy, savoury, spicy, or thick and creamy, so the menu name must identify the actual sauce, ingredients and cooking style."),
    ...
    DishSpec("soup", "수프", "Soup", ("수프", "스프", "크림스프", "양송이스프", "단호박스프", "콘스프", "토마토스프", "머쉬룸스프", "오늘의 수프", "soup"), None, "Soup is a liquid-based dish in which vegetables, grains, meat, seafood or other components are cooked or combined with broth or a purée. Clear broth, blended vegetable and cream-style soups belong to the same broad food form.", "Soup is often served warm or hot, although some styles are served cool. It can be clean and mild, savoury, spicy, thin, or thick and rich; the family name gives no reliable ingredient or allergen guarantee."),
    ...
    DishSpec("cheese_balls", "치즈볼", "Cheese balls", ("치즈볼", "cheese balls"), None, "Cheese balls are bite-sized savoury snacks with a cheese-style centre or flavour, commonly enclosed in dough or a crumbed shell. Restaurant versions may be fried or baked until the outside is browned.", "They are usually served warm or hot with a crisp or chewy exterior and a soft, thick and rich centre. The exact cheese, dairy, coating and cooking method require product information."),
    ...
    DishSpec("rice_bowl", "덮밥", "Rice bowl", ("덮밥", "rice bowl"), None, "A rice bowl is a meal format placing a cooked topping, sauce or composed ingredients over a base of rice. Stir-fried, grilled, simmered, raw and vegetable toppings can all appear in this form.", "It is generally served warm or hot and combines soft or chewy rice with textures determined by the topping. The broad format does not establish cuisine, protein, sauce, cooking method or spice level."),
    ...
    DishSpec("donut", "도넛", "Doughnut", ("도넛", "도너츠", "doughnut", "donut"), "american", "A doughnut is a sweet dough product shaped and cooked as a ring or filled piece. It is usually fried, while some bakery styles are baked, so the product label remains the authority for cooking method.", "Doughnuts are sweet and commonly served at room temperature, with a soft or chewy centre and a browned, sometimes crisp exterior. Glaze, sugar, filling, toppings and allergens vary by product."),
    ...
    DishSpec("cookie", "쿠키", "Cookie", ("쿠키", "cookie"), None, "A cookie is a small baked sweet made in styles ranging from thin and crisp or crunchy to thick, soft and chewy. It is usually eaten at room temperature, although some bakery cookies are served warm.", "Cookies are generally sweet and may be plain, filled or topped. Butter, chocolate, fruit, nuts and spices are possible flavour directions rather than guaranteed ingredients, so product labelling remains necessary for allergens."),
    ...
    DishSpec("yogurt", "요거트", "Yogurt", ("요거트", "요구르트", "yogurt"), None, "Yogurt is a cultured food or drink family with plain, sweetened, frozen and topping-based formats. Spoonable bowls, drinks and frozen desserts can therefore share the same broad name.", "It is usually served cool or frozen, with a tangy, sour or sweet flavour and a soft, thick and creamy or drinkable texture. Dairy-free versions exist, so the name alone is not a dairy guarantee."),
    ...
    DishSpec("fried_rice", "볶음밥", "Fried rice", ("볶음밥", "fried rice"), None, "Fried rice is a broad rice-dish family in which cooked rice grains are stir-fried over heat with seasoning and optional vegetables or protein. The wok or pan preparation distinguishes it from a topped rice bowl.", "It is served hot or warm with separated, soft or chewy grains and a savoury, sometimes smoky profile. Cuisine, oil, protein, sauces and spice level vary by product."),
)
